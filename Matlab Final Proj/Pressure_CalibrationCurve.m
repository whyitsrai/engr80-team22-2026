...
%% Author: Team 22
%% Date: 16 Feb 2026
%% Purpose: To add a regression lines and appropriate measures of uncertainty to the pressure vs voltage calibration curve

%%% TU to VOLTAGE:1 Teensy unit = 0.0032143V
% We will create x vector as the dept in meters and the output voltage
% measured.


x = [877 864 852 845 832 823]; % Teensy Unit [TU]
y = [0 0.2 0.4 0.6 0.8 1]; % Dept [m]
...
legend('Data Points','Best Fit Line','Upper Func. Bound',...
    ...
    'Location', location)
title("Teensy Unit [TU] vs. Depth [m] Pressure Calibration Curve")
hold off
