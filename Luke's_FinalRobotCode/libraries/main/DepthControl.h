...
#define DEPTH_MARGIN 0.2  // how close (m) the robot must be to start the dwell timer
#define MAX_CONTROL_EFFORT 180
#define DEPTH_DEADBAND 0.05 // zeroes uV when within this distance; keep <= DEPTH_MARGIN

#include <Arduino.h>
#include "MotorDriver.h"
#include "ZStateEstimator.h"
// extern MotorDriver motorDriver; // removed: name didn't match global (motor_driver) and was never used
...
public:
  ...
  float Kp=150.0;     // proportional control gain — lowered from 1000 (tune later)
