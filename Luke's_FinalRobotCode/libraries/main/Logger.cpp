...
void Logger::log(void){
	// Guard before doing any work: stop logging once file size limit is reached.
	// Previously keepLogging = true at the bottom unconditionally overwrote this
	// check, so the limit never fired. Early return fixes it.
