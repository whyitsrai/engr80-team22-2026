%% Author: Team 22
%% Date: 9 Feb 2025
%% Purpose: To find the ratio of the 90° Vpp to the transmission Vpp against the calibrated turbidity of the solutions
%% and add the line of bestfit with uncertainty measurements

%x = readmatrix("E79 Step response (1).csv")

NinetyVpp = [3, 4, 5, 6]; % edit during lab
TransmissionVpp = [3, 2, 8, 5] % edit during lab
% We will create another vector to find ratio between 90° Vpp to the transmission Vpp
x = NinetyVpp./TransmissionVpp;
y = [0.77, 0.88, 0.80, 1]; % turbidity values % edit during lab
% We will create another to find the respective turbidities of the solutions from the TU-2016
...
xlabel('90° Vpp/Transmission Vpp')
ylabel('Calibrated Turbidities Value')
if beta1 > 0 % Fix this
    location = 'northwest';
else
    location = 'northeast';
...
legend('Data Points','Best Fit Line','Upper Func. Bound',...
    ...
    'Location', location)
title("Ratio of the 90° Vpp to the transmission Vpp vs the calibrated turbidity our solutions")
hold off