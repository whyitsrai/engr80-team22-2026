...
#define MAX_PITCH_EFFORT 150 // Mmax differential effort; tune later
#define PITCH_DEADBAND 3.5 // degrees of error that we consider "close enough" to the desired pitch; tune later
